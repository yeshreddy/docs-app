...
public class AdminController {
	...
	public ModelAndView appSettings(ModelAndView mav) {
		if(true){
			mav.addObject("appName", properties.getProperty("appName"));
			mav.addObject("copyRight", properties.getProperty("copyRight"));
			mav.setViewName("/admin/viewApp");
		}else{
			mav.setView(new RedirectView("/docs-app/admin/app-settings-edit"));
		}
		return mav;
	}
	
	@RequestMapping(value = "/admin/app-settings-edit", method = RequestMethod.GET)
	public ModelAndView appSettingsEdit(ModelAndView mav) {
		mav.addObject("appName", properties.getProperty("appName"));
		mav.addObject("copyRight", properties.getProperty("copyRight"));
